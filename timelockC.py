...
CURRENT_TIME = input()
EPOCH_TIME = "2021 01 01 00 00 00"
...
CURRENT_TIME = datetime(int(CURRENT_TIME[0]), int(CURRENT_TIME[1]), int(CURRENT_TIME[2]), int(CURRENT_TIME[3]), int(CURRENT_TIME[4]), int(CURRENT_TIME[5]))
...
print(code + myHash[len(myHash) - 1 ])
#print(code)
